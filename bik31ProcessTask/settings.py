"""
Django settings for bik31ProcessTask project.
...
SECRET_KEY = 'django-insecure-xw)_s@0$%k%)yo3$q5)q@29-hm6*9-qqyupzr8(%y(bv0owksr'
...
WSGI_APPLICATION = 'bik31ProcessTask.wsgi.application'
...
FRONTEND_BUILD_DIR = BASE_DIR.parent / 'bik31-reestr'
STATICFILES_DIRS = [
